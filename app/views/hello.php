        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-5">
                            <form id="login-form" action="/create" method="post" role="form" style="display: block;">
                                <div class="form-group">
                                    <input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="email" value="">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="group" id="group" tabindex="1" class="form-control" placeholder="group" value="">
                                </div>
                                <!--<div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                <a href="/index" tabindex="5" class="forgot-password">cancel </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
